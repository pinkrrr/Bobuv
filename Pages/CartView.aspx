<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CartView.aspx.cs" Inherits="Bobuv.Pages.CartView"
...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContent" runat="server">
    <div id="content">
        ...
        <table id="cartTable">
            ...
            <tbody>
                <asp:Repeater ID="Repeater1" ItemType="Bobuv.Models.CartLine"
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><%# ((Item.Quantity * 
                                Item.Shoe.Price).ToString("c"))%></td>
                            <td>
                                <button type="submit" class="actionButtons" name="remove"
                                    value="<%#Item.Shoe.ShoeId %>">
                                    Удалить</button>
                            </td>
                        </tr>
                    </ItemTemplate>
